...
<article class="post post">
    ...
    <section class="post-excerpt">
        <p>とあるシステムで簡単なアクセス解析をする必要があったため、 せっかくなので存在だけは知っていたKeen.ioを使ってみた。 keen.io keen.ioはかしこいんだよねー。keen.ioはかしこいんだよねー。 <a class="read-more" href="http://onori.github.io/post/laravel-keenio-heroku">&raquo;</a></p>
    </section>
